  ...
  Widget build(BuildContext context) {
    return CustomScaffold(
      appBar: const PrimaryAppBar(
        title: 'Detail Internet Provider',
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          GridView.builder(
            shrinkWrap:
                true, // Penting supaya GridView bisa berada dalam ScrollView
            physics:
                const NeverScrollableScrollPhysics(), // Supaya grid ikut scroll parent (bukan scroll sendiri)
            itemCount: 4, // jumlah voucher
            gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
              crossAxisCount: 2, // 2 kolom
              crossAxisSpacing: 24, // jarak antar kolom
              mainAxisSpacing: 24, // jarak antar baris
              childAspectRatio:
                  2.2, // rasio width/height tiap box (bisa diatur supaya kotaknya pas)
            ),
            itemBuilder: (context, index) {
              return _voucherBox(context, selected: index == 0);
            },
          ),
          const Gap(Sizes.p24),
          Padding(
