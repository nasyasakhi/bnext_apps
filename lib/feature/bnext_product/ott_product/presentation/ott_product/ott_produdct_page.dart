...
@RoutePage()
class OttProductPage extends StatelessWidget {
  const OttProductPage({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) => sl<ProductCubit>()..getProductsByCategory("ott-product"),
              ...
              return Padding(
                ...
                child: GridView.count(
                  ...
                  children: products.map((product) {
                    ...
                    onTap: () {
                      context.router.push(
                        OttProductOrderRoute(product: ProductModel.fromEntity(product))
